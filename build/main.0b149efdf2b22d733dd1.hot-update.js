...
/* harmony import */ var _DistributionCentersActions__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../DistributionCentersActions */ "./src/common/distributionCenters/DistributionCentersActions.js");
...
var _jsxFileName = "/srv/app/src/common/distributionCenters/pages/List.js";
// IMPORTS
// Material UI
...
function (_Component) {
  ...
  function List(props) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this), "onChangePage", function (event, newPage) {
      _this.props.fetchDistributionCenters(newPage + 1, _this.props.filters, _this.state.rowsPerPage).then(function (data) {});
    });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(_material_ui_core_Paper__WEBPACK_IMPORTED_MODULE_8___default.a, {
        ...
        return react__WEBPACK_IMPORTED_MODULE_18___default.a.createElement(_material_ui_core_TableRow__WEBPACK_IMPORTED_MODULE_13___default.a, {
          ...
          to: "/distributioncenters/".concat(item.id, "/edit"),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 69
          }
          ...
          size: "small",
          component: react_router_dom__WEBPACK_IMPORTED_MODULE_20__["Link"],
          to: "/distributioncenters/".concat(item.id, "/delete"),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 77
          }
          ...
          size: "small",
          component: react_router_dom__WEBPACK_IMPORTED_MODULE_20__["Link"],
          to: "/distributioncenters/".concat(item.id, "/list-fleets"),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 85
          }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return Object(redux__WEBPACK_IMPORTED_MODULE_21__["bindActionCreators"])({
    fetchDistributionCenters: _DistributionCentersActions__WEBPACK_IMPORTED_MODULE_23__["fetchDistributionCenters"]
  }, dispatch);
};
...
//# sourceMappingURL=main.0b149efdf2b22d733dd1.hot-update.js.map