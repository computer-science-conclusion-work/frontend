...
/*!*******************************************!*\
  !*** ./src/common/stores/StoreActions.js ***!
  \*******************************************/
/*! exports provided: REMOVE_STORE, SUBMIT_STORE, FETCH_STORE, EDIT_STORE, fetchStores, edit, post, update, destroy */
...
function fetchStores(page) {
  ...
  return function (dispatch) {
    ...
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/store?filters=").concat(JSON.stringify(filters), "&&page=").concat(page, "&&rows=").concat(rows || _consts__WEBPACK_IMPORTED_MODULE_2__["default"].DEFAULT_PAGINATION), {
      page: page,
      filters: filters
    }).then(function (resp) {
...
function destroy(id) {
  return function (dispatch) {
    ...
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/store/").concat(id)).then(function (resp) {
      return resp.data;
    }).then(function (data) {
...
//# sourceMappingURL=main.97ae555c6e327da61af8.hot-update.js.map