...
function fetchDistributionCenters(page) {
  ...
  return function (dispatch) {
    ...
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/distributioncenter?filters=").concat(JSON.stringify(filters), "&&page=").concat(page, "&&rows=").concat(rows || consts.DEFAULT_PAGINATION), {
      page: page,
      filters: filters
    }).then(function (resp) {
...
function edit(id) {
  return function (dispatch) {
    dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["default"])(EDIT_DISTRIBUTION_CENTER.ACTION, {
      id: id
    }));
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/distributioncenter/").concat(id)).then(function (resp) {
      ...
      return dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["default"])(EDIT_DISTRIBUTION_CENTER.SUCCESS, data));
    })["catch"](function (e) {
      return dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["actionFailed"])(EDIT_DISTRIBUTION_CENTER, e));
    });
  };
}
...
function submit(values, method) {
  ...
  return function (dispatch) {
    dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["default"])(SUBMIT_DISTRIBUTION_CENTER.ACTION));
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a[method]("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/distributioncenter").concat(id), values).then(function (resp) {
      ...
      dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["default"])(SUBMIT_DISTRIBUTION_CENTER.SUCCESS, data));
      dispatch(fetchDistributionCenters());
      return data;
    })["catch"](function (e) {
      return dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["actionFailed"])(SUBMIT_DISTRIBUTION_CENTER, e));
    });
  };
}
...
function remove(id) {
  return function (dispatch) {
    dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["default"])(REMOVE_DISTRIBUTION_CENTER.ACTION));
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/api/distributioncenter/").concat(id)).then(function (resp) {
      ...
      dispatch(Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["default"])(REMOVE_DISTRIBUTION_CENTER.SUCCESS, data));
      dispatch(fetchDistributionCenters());
    })["catch"](function (e) {
      return Object(_util_action__WEBPACK_IMPORTED_MODULE_2__["actionFailed"])(REMOVE_DISTRIBUTION_CENTER.FAILURE, e);
    });
  };
}
...
//# sourceMappingURL=main.0f378f8199218c4fa4d9.hot-update.js.map