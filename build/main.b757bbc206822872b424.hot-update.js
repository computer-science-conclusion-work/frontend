...
/*!**********************************************************************!*\
  !*** ./src/common/distributionCenters/DistributionCentersActions.js ***!
  \**********************************************************************/
/*! exports provided: REMOVE_DISTRIBUTION_CENTER, SUBMIT_DISTRIBUTION_CENTER, FETCH_DISTRIBUTION_CENTER, SAVE_DISTRIBUTION_CENTER_SUPPLIER, FETCH_DISTRIBUTION_CENTER_TO_SUPPLIER, EDIT_DISTRIBUTION_CENTER, fetchDistributionCenters, edit, post, update, remove, fetchDistributionCentersPerSuppliers, saveDCSupplier, fetchDistributionCentersPerStores, saveDistributionCentersPerStores */
...
function saveDistributionCentersPerStores(values, id) {
  return function (dispatch) {
    ...
    return axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post("".concat(_config__WEBPACK_IMPORTED_MODULE_1__["default"].API_URL, "/store/").concat(id, "/distributioncenters"), values).then(function (resp) {
      return resp.data;
    }).then(function (data) {
...
//# sourceMappingURL=main.b757bbc206822872b424.hot-update.js.map