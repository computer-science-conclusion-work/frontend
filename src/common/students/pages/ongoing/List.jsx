...
class List extends EnhancedComponent {
  ...
  handleNote = index => event => {
    let localState = this.state.fields.ongoing
  ...
  onSubmit = e => {
    e.preventDefault()
    this.props.onSubmit && this.props.onSubmit(this.state.fields.ongoing)
  }
  ...
  render() {
    ...
    const { ongoing } = this.state.fields
    return (
        <ValidatorForm
            ref="form"
