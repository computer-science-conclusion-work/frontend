...
class List extends EnhancedComponent {
  ...
  handleNote = index => event => {
    let localState = this.state.fields.curriculum
  ...
  onSubmit = e => {
    e.preventDefault()
    this.props.onSubmit && this.props.onSubmit(this.state.fields.curriculum)
  }
  ...
  render() {
    ...
    const { curriculum } = this.state.fields
    return (
        <ValidatorForm
            ref="form"
